...
export function AgentSidebar() {
  ...
  return (
    <div className="w-80 border-r border-border bg-muted/30 h-full">
      <div className="border-b border-border p-4">
        <h2 className="font-medium">Micro-Agents</h2>
      ...
      <div className="p-4 space-y-4 h-full overflow-auto figma-scrollbar">
          ...
          <div className="space-y-2">
            {microAgents.map((agent) => {
              ...
              return (
                <Card
                  key={agent.id}
                  className="p-3 cursor-grab hover:shadow-sm transition-shadow border-border active:cursor-grabbing"
                  draggable
        ...
        <div>
          <h3 className="font-medium mb-3 text-sm">Custom Agents</h3>
          <Card className="p-4 border-dashed border-2 border-muted-foreground/25 text-center">
