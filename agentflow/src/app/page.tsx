...
export default function AgentFlowDesigner() {
  ...
  return (
    <div className="h-screen w-full flex overflow-hidden" style={{ backgroundColor: colors.background }}>
      ...
      {/* Right Properties Panel (moved to be sibling of Main Content) */}
      {selectedNode && (
        <div 
        ...
        >
          ...
          <div className="h-12 border-b flex items-center justify-between px-4" style={{ borderColor: colors.border }}>
            <h3 className="font-medium" style={{ color: colors.text }}>Properties</h3>
            <button
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                defaultValue={nodes.find(n => n.id === selectedNode)?.data.title || ''}
            ...
            <div>
              ...
              <textarea
                ...
                defaultValue={nodes.find(n => n.id === selectedNode)?.data.description || ''}
              />
            </div>
